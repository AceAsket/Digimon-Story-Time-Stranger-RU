#!/usr/bin/env python3
"""Apply the source-checked final example-calque correction."""
...
UPDATES: list[tuple[str, str, str, int, str, str]] = [
    ("patch_text01", "message/m310.mbe/000_Sheet1.csv", "m310_070_010", 2,
     "f8c0d212edcefdf15f19bcb120b72d92f7371a95b17064477c2c137fff4b8d8a",
     "Шло время... Робкий младший брат остался верен обещанию,\n"
     "которое дал старшему, и вырос в доблестного воина."),
]
