...
SPECIAL_ID_ALIASES = {
    ...
    "BACCHUSMON_DRUNK": ["Bacchusmon Deisui Mode", "Bacchusmon Drunk Mode", "Bacchusmon DM"],
    "BELIALVAMDEMON": ["Belial Vamdemon", "MaloMyotismon"],
    "BEELZEMON_BM": ["Beelzebumon Blast Mode", "Beelzebumon: Blast Mode", "Beelzemon Blast Mode"],
    "BEELZEMON_BM_BIG": ["Beelzebumon Blast Mode", "Beelzebumon: Blast Mode", "Beelzemon Blast Mode"],
    "BELPHEMON_RM": ["Belphemon Rage Mode", "Belphemon: Rage Mode"],
    "BELPHEMON_RM_BIG": ["Belphemon Rage Mode", "Belphemon: Rage Mode"],
    "BELPHEMON_SM": ["Belphemon Sleep Mode", "Belphemon: Sleep Mode"],
    "BELPHEMON_SM_BIG": ["Belphemon Sleep Mode", "Belphemon: Sleep Mode"],
    ...
    "CHRONOMON_DESTROY": ["Chronomon Destroy Mode", "Chronomon: Destroy Mode"],
    ...
    "DUKEMON_CM": ["Dukemon Crimson Mode", "Dukemon: Crimson Mode", "Gallantmon Crimson Mode", "Gallantmon: Crimson Mode"],
    ...
    "JUNOMON_HYSTERICMODE": ["Junomon Hysteric Mode", "Junomon: Hysteric Mode"],
    "JUNOMON_HYSTERICMODE_ADD": ["Junomon Hysteric Mode", "Junomon: Hysteric Mode"],
    ...
    "SHINEGREYMON_BM": ["Shine Greymon Burst Mode", "Shine Greymon: Burst Mode", "ShineGreymon Burst Mode"],
    "SKULLMAMMON": ["Skull Mammothmon", "SkullMammothmon"],
    "SOCERIMON": ["Sorcermon", "Sorcerimon"],
    "RAVEMON_BM": ["Ravemon Burst Mode", "Ravemon: Burst Mode"],
    "ROSEMON_BM": ["Rosemon Burst Mode", "Rosemon: Burst Mode"],
