...
add(
    ...
    "m170_065_310",
    "Мы разберёмся! Узнаем, что случилось!",
)
add(
    "message/m170.mbe/000_Sheet1.csv",
    "m170_065_320",
...
add(
    ...
    "m210_050_020",
    "Судя по показаниям твоего Дигивайса, возникло совсем слабое\n"
...
add(
    ...
    "m420_090_030",
    "Как и в круговороте времени, равновесие сохраняется,\n"
    "пока всё взаимосвязано.",
)
add(
    "message/m440.mbe/000_Sheet1.csv",
    "m440_130_030",
    "Так война никогда не произойдёт, и всё, что она потеряла,\n"
    "вернётся.",
)
add(
...
add(
    "message/m050.mbe/000_Sheet1.csv",
    "m050_030_200",
    "Не нужно напрягаться. Я лишь хочу узнать, что тебе известно.",
)
add(
...
add("message/m170.mbe/000_Sheet1.csv", "m170_020_140", "Хи-хи! И правда хлопотно, да?")
add("message/m170.mbe/000_Sheet1.csv", "m170_020_150", "Но важные дела обычно такими и бывают.")
add(
...
add(
    "message/m230.mbe/000_Sheet1.csv",
    "m230_010_080",
    "То есть в твоём времени, {player}?",
)
add(
...
add(
    ...
    "m260_080_290",
    "Хорошо, возьмёмся за это дело.{next}",
)
add(
...
add(
    "message/m390.mbe/000_Sheet1.csv",
    "m390_060_060",
    "Столько раз, что уже не сосчитать. После этого я всё понял.",
)
