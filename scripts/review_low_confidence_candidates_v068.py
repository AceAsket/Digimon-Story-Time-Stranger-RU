...
NON_PLAYER_ADDRESS_POSITIONS = {
    *range(1, 10), *range(17, 22), 26, *range(36, 39), 40, 50, 52, 53, 69,
    92, 93, 97, 99, 101, 104, *range(106, 109), 114, 117, 119, 120,
    *range(122, 130), *range(131, 135), 137, 138, 140, 141, 143, 145, 156,
    165, 169, 174, *range(177, 180), 181, *range(185, 188), 190, 193, 195, 196,
}

# This line is clearer and fully gender-neutral after manual rewriting, so it
# does not need two runtime rows.
NEUTRALIZED_PLAYER_ADDRESS = {"g_degi_h0211_0020", "m070_060_040"}
...
VARIANT_OVERRIDES: dict[str, tuple[str, str]] = {
    ...
    "s050_038_0120": (
        "О, не знал, что ты занят. Приходи, когда будет время!",
        "О, не знал, что ты занята. Приходи, когда будет время!",
    ),
    "s050_042_0270": (
        "Ты нашёл перо Парротмона?! Отлично, отдавай.",
        "Ты нашла перо Парротмона?! Отлично, отдавай.",
    ),
    "s030_029_080": (
    ...
    "s200_148_390": (
        ...
        "Да... ты права! Может, люди не так страшны, как я думал?",
    ),
    "f_t0103_9000_0040": (
...
STYLE_UPDATES: dict[str, str] = {
    ...
    "m090_080_090": "Я пришла из Илиады — Цифрового мира, своего рода параллельной\nвселенной к Материальному миру, где живёте вы.",
    ...
    "s200_146_120": "Вы приобрели эту форму на незаконном аукционе? Использование\nказённого снаряжения не по назначению — серьёзное преступление...",

    # awkward "довольно"
    "arena01_f001_007_030": "Совпадение или хитрый план? Они выбывали один за другим! Хороши\nли они? Кто знает? Но запашок от них ещё тот!",
    "arena01_f001_011_040": "Давно не виделись, малыш! Но у меня дел по горло, так что\nдавай покончим с этим побыстрее!",
    "f_d0201_0600_0030": "...но мириться с их уровнем жизни нам непросто.",
    ...
    "d220_060_130": "Спасибо за заботу.\nОт тебя и правда исходит невероятная сила.",
    ...
    "m350_120_010": "Ах... Вижу, ты стал сильнее. Какая радость.",
    ...
    "s090_072_770": "Значит, ты и правда связан с нами, дигимонами!\nТеперь я наконец смогу вернуться домой, да?!",
