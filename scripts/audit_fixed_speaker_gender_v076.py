...
FEMALE_SPEAKERS = {
    ...
    "char_HIGH_SCHOOL_GIRL_2",
    "char_FEMALE_STUDENT",
    "char_WOMAN",
    "char_YOUNG_WOMAN",
    "char_WOMAN_LIKE_MOTHER",
    "char_LILITHMON",
    "char_LADYDEVIMON",
    "char_ANGEWOMON",
    "char_JUNOMON",
...
MALE_SPEAKERS = {
    ...
    "char_OMNIMON",
    "char_OMNIMON_ANTE",
    "char_OMNIMON_ALTER_S",
    "char_OMNIMON_MERCIFULMODE",
    "char_PAILDRAMON",
    "char_RAVEMON",
    "char_SUBMARIMON",
    "char_WHAMON",
